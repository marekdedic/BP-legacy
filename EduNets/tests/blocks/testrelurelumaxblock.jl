...
function testrelurelumax1()
  ...
  k=(size(ds.x,1),5,1)
  model=EduNets.ReluReluMaxBlock(k;T=Float64);
  g=EduNets.ReluReluMaxBlock(k;T=Float64);
...
println("testing calculation of gradient of ReluReluMaxBlock without pre-allocation of outputs")
testrelurelumax1();
