...
function initializeModelUrl(;file::AbstractString="dataset.jld", percentage::Float32 = 0.9f0);
	...
	model = UrlModelCompound((ReluLayer((startLayers, insideLayers); T = Float32), MeanPoolingLayer(insideLayers; T = Float32)), (ReluLayer((startLayers, insideLayers); T = Float32), MeanPoolingLayer(insideLayers; T = Float32)), (ReluLayer((startLayers, insideLayers); T = Float32), MeanPoolingLayer(insideLayers; T = Float32)), (LinearLayer((3 * insideLayers, 1); T=Float32),), HingeLoss(;T = Float32));
